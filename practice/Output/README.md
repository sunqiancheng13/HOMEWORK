...
编译报错，ojb需要类型强转   ((Test)obj).getInfo();
```
#### 3.
```
interface A
...
报错    接口类中定义的变量默认是  publie static final
```
...
public class MainClass
{
    public static void main(String[] args)
    {
        ...
        System.out.println(d.i);    1111
         
        System.out.println(d.methodA());    1112
...
public class MainClass
{
	public static void main(String[] args)
	{
		...
		System.out.println(c.methodA());     DDDAAABBB
		
		System.out.println(c.methodB());     DDDBBBAAA
	}
}
```
